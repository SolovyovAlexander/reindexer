...
public:
	...
	void Modify(IdType itemId, const NsContext &ctx, bool updateWithJson, h_vector<cluster::UpdateRecord, 1> &pendedRepl);
...
private:
	...
	void modify(IdType itemId, h_vector<cluster::UpdateRecord, 1> &pendedRepl);
	void modifyCJSON(IdType itemId, h_vector<cluster::UpdateRecord, 1> &replUpdates, const NsContext &ctx);
	void modifyField(IdType itemId, FieldData &field, Payload &pl, h_vector<cluster::UpdateRecord, 1> &pendedRepl);
