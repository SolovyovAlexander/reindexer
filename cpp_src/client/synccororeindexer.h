...
public:
	...
	Error Select(string_view query, SyncCoroQueryResults &result);
	...
	Error GetMeta(string_view nsName, const std::string &key, std::string &data);
	/// Put meta data to storage by key
	/// @param nsName - Name of namespace
	/// @param key - string with meta key
	/// @param data - string with meta data
	Error PutMeta(string_view nsName, const std::string &key, const string_view &data);
	/// Get list of all meta data keys
	/// @param nsName - Name of namespace
	/// @param keys - std::vector filled with meta keys
	Error EnumMeta(string_view nsName, std::vector<std::string> &keys);
	...
	/// @param nsName - Name of namespace
	SyncCoroTransaction NewTransaction(string_view nsName);
	...
	SyncCoroReindexer WithServerId(int sId) { return SyncCoroReindexer(impl_, ctx_.WithServerId(sId)); }
